package com.tencent.yolov5ncnn.Marking;
...
public class DetectorFactory {
    public static YoloV5Classifier getDetector(
        ...
        if (modelFilename.equals("traffic.tflite")) {
            labelFilename = "file:///android_asset/trafficClasses.txt";
            isQuantized = true;
            inputSize = 320;
        ...
        }else if (modelFilename.equals("marking.tflite")) {
            labelFilename = "file:///android_asset/Mark_classes.txt";
            isQuantized = true;
            inputSize = 320;
            output_width = new int[]{40, 20, 10};
            masks = new int[][]{{0, 1, 2}, {3, 4, 5}, {6, 7, 8}};
